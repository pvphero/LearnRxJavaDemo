...
public class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = SuperUtils.getApp()
                    .getPackageManager()
                    .getPackageInfo(SuperUtils.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && SuperUtils.getApp().getExternalCacheDir() != null) {
                mDefaultDir = SuperUtils.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                mDefaultDir = SuperUtils.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
